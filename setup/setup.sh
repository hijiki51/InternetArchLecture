...
docker run -d --name ns --hostname=ns --net=host --privileged  -v named:/etc/bind/named.conf -v lib_bind:/var/lib/bind -v cache_bind:/var/cache/bind ubuntu/bind9:latest
